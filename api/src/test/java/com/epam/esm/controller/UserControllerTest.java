...
class UserControllerTest {
    ...
    @Test
    void findUser_existentUserId_ok() throws Exception {
    ...
    @Test
    void findTag_nonExistentUserId_notFound() throws Exception {
    ...
    @Test
    void findOrders_correctPaginationParameters_ok() throws Exception {
    ...
    @Test
    void findOrder_existentOrderIdByUser_ok() throws Exception {
    ...
    @Test
    void findOrder_NotValidData_badRequest() throws Exception {
        CustomException ex = new CustomException("error", CustomErrorCode.NOT_VALID_DATA);
    ...
    @Test
    void findOrder_nonExistentOrderIdByUser_notFound() throws Exception {
        CustomException ex = new CustomException("error", CustomErrorCode.RESOURCE_NOT_FOUND);
        Mockito.when(orderServiceMock.findByIdAndByUser(1L, 1L)).thenThrow(ex);
    ...
    @Test
    void createOrder_correctCertificateList_ok() throws Exception {
